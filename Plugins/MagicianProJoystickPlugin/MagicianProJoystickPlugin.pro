#-------------------------------------------------
#
# Project created by QtCreator 2020-09-10T14:59:31
#
#-------------------------------------------------
QT -= gui
QT += core serialport
...
CONFIG(release, debug|release): {
    TARGET = MagicianProJoystickPlugin
} else:CONFIG(debug, debug|release): {
    TARGET = MagicianProJoystickPlugin_d
}



DEFINES += MAGICIANPROJOYSTICKPLUGIN_LIBRARY
