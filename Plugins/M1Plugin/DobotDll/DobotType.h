...
typedef struct tagTimeRecord {
int bootSecond;         //此次开机时长
int bootSecondTotal;    //总计开机时长
int haltSecondTotal;    //总关时长
int motorRunSecond[4];  //电机运行时长
}TimeRecord;
...
enum {
    ...
    DobotConnect_AllReadyConnected,
    DobotConnect_Unknown
};
