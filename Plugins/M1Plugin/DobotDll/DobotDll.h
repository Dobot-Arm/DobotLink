...
extern "C" DOBOTDLLSHARED_EXPORT int GetDeviceVersion(uint8_t typeIndex, uint8_t *majorVersion, uint8_t *minorVersion, uint8_t *revision, char *A9_version);
...
//extern "C" DOBOTDLLSHARED_EXPORT int GetStatus(uint8_t *status);
extern "C" DOBOTDLLSHARED_EXPORT int GetTimeRecord(TimeRecord *timeRecord);
extern "C" DOBOTDLLSHARED_EXPORT int GetPowerStatus(uint8_t *status);
extern "C" DOBOTDLLSHARED_EXPORT int SetPowerStatus(uint8_t status);
...
extern "C" DOBOTDLLSHARED_EXPORT int ResetRobot();
extern "C" DOBOTDLLSHARED_EXPORT int SetHOMECmd(uint8_t isResetPars, bool isQueued, uint64_t *queuedCmdIndex);
...
extern "C" DOBOTDLLSHARED_EXPORT int SetExcitCmd(ExcitCmd *ExcitCmd, bool isQueued, uint64_t *queuedCmdIndex);
extern "C" DOBOTDLLSHARED_EXPORT int SetExcitZCmd(ExcitZCmd *ExcitCmd, bool isQueued, uint64_t *queuedCmdIndex);
extern "C" DOBOTDLLSHARED_EXPORT int SetExcit6AxisCmd(Excit6AxisCmd *ExcitCmd, bool isQueued, uint64_t *queuedCmdIndex);

// Servo Motion
extern "C" DOBOTDLLSHARED_EXPORT int SetServojCmd(PTPCmd *ptpCmd, bool isQueued, uint64_t *queuedCmdIndex);
extern "C" DOBOTDLLSHARED_EXPORT int SetServopCmd(PTPCmd *ptpCmd, bool isQueued, uint64_t *queuedCmdIndex);
...
extern "C" DOBOTDLLSHARED_EXPORT int GetIODIs(IODIs *ioDIs);
/*
...
extern "C" DOBOTDLLSHARED_EXPORT int GetQueuedCmdLeftSpace(uint64_t *leftSpace);

// test
extern "C" DOBOTDLLSHARED_EXPORT int SetUserCoordParams(CoordParams *userCoordParams, bool isQueued, uint64_t *queuedCmdIndex);
extern "C" DOBOTDLLSHARED_EXPORT int SetToolCoordParams(CoordParams *toolCoordParams, bool isQueued, uint64_t *queuedCmdIndex);
extern "C" DOBOTDLLSHARED_EXPORT int SetUserAndToolCoordParams(CoordParams *userCoordParams, CoordParams *toolCoordParams);

// Function-Dynamic
extern "C" DOBOTDLLSHARED_EXPORT int SetSafeMode(uint8_t safeMode);
extern "C" DOBOTDLLSHARED_EXPORT int GetSafeMode(uint8_t *safeMode);
extern "C" DOBOTDLLSHARED_EXPORT int SetExcitMode(uint8_t excitMode);
extern "C" DOBOTDLLSHARED_EXPORT int GetExcitMode(uint8_t *excitMode);
extern "C" DOBOTDLLSHARED_EXPORT int SetCollisionThreshold(TorDiffParams *torDiffParams);
extern "C" DOBOTDLLSHARED_EXPORT int GetCollisionThreshold(TorDiffParams *torDiffParams);
extern "C" DOBOTDLLSHARED_EXPORT int SetBasicDynamicParams(BasicDynamicParams *basicDynamicParams);
extern "C" DOBOTDLLSHARED_EXPORT int GetBasicDynamicParams(BasicDynamicParams *basicDynamicParams);
extern "C" DOBOTDLLSHARED_EXPORT int SetPlayLoad(float playLoad);
extern "C" DOBOTDLLSHARED_EXPORT int GetPlayLoad(float *playLoad);
extern "C" DOBOTDLLSHARED_EXPORT int GetTrajectory(TrajectoryData *datas, uint8_t *count, uint8_t countMax, uint64_t index);
extern "C" DOBOTDLLSHARED_EXPORT int GetCollisionCount(CollisionCount *count);
extern "C" DOBOTDLLSHARED_EXPORT int SetSafeStrategy(uint8_t flag);
extern "C" DOBOTDLLSHARED_EXPORT int GetSafeStrategy(uint8_t *flag);

extern "C" DOBOTDLLSHARED_EXPORT int SetSafeGuardMode(uint8_t status);
extern "C" DOBOTDLLSHARED_EXPORT int GetSafeGuardMode(uint8_t *status);
extern "C" DOBOTDLLSHARED_EXPORT int SetSafeGuardStatus(uint8_t status);
extern "C" DOBOTDLLSHARED_EXPORT int GetSafeGuardStatus(uint8_t *status);
...
extern "C" DOBOTDLLSHARED_EXPORT int ArcDiscrete(stScaraPose beginPos, stScaraPose midPos, stScaraPose endPos, uint8_t size, pstScaraPose result);

//Inch
extern "C" DOBOTDLLSHARED_EXPORT int SetInchMode(uint8_t InchMode);
extern "C" DOBOTDLLSHARED_EXPORT int GetInchMode(uint8_t *InchMode);
extern "C" DOBOTDLLSHARED_EXPORT int SetInchParam(InchParamsDef *InchParam);
extern "C" DOBOTDLLSHARED_EXPORT int GetInchParam(InchParamsDef *InchParam);
