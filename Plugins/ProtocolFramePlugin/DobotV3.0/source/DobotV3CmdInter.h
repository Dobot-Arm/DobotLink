...
struct DobotV3CmdInter_PcaketParm {
    ...
    uint8_t repeatNum;              /* 重发次数 */
    uint32_t timeOut;               /* 超时重发时间 */
...
struct DobotV3CmdInterParm {
    ...
    uint32_t defaultTimeOut;                                /* 默认超时时间 */
    uint8_t defaultRepeatNum;                               /* 默认重发次数 */
};
...
struct SDobotV3CmdInterAPI {
    ...
    ** Remarks:             None
    *************************************************************/
    uint8_t (*GetCmdSpace)(PDobotV3CmdInter_HANDLE pHandle, PProtocolFrame_FuncSTRUCT pFuncStruct);
    /*************************************************************
    ...
    ** Returned value:      None
    *************************************************************/
    void (*SetSendParm)(PProtocolFrame_FuncSTRUCT pFuncStruct,
                        uint8_t repeatNum,
                        uint32_t timeOut);
    /*************************************************************
