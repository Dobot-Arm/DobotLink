...
/*************************************************************
** Function name:       General_RegisterCB
...
** Remarks:             None
*************************************************************/
bool General_RegisterCB(uint16_t id, DobotV3CmdInter_CB CB)
{
    return gDobotV3CmdInterAPI.RegisterCB(&GeneralRulesCB, id, CB);
}

/*************************************************************
** Function name:       General_RulesSort
** Descriptions:        匹配分类
...
*************************************************************/
uint8_t General_RulesSort(PDobotV3Format_Packet pSendPacket, uint16_t length)
{
    return pSendPacket->cmdSet == DobotV3Format_COMMON;
}
/*************************************************************
** Function name:       General_RulesMatch
** Descriptions:        指令匹配
** Input parameters:    pSendPacket:发送的数据包
...
*************************************************************/
uint8_t General_RulesMatch(PDobotV3Format_Packet pSendPacket, PDobotV3Format_Packet pReadPacket)
{
    switch(pSendPacket->version) {
        case DobotV3Format_VER_11:
...
/* 定义通用规则回调函数列表参数 */
DobotV3CmdInter_CMDCB_LS_EXPORT(GeneralRulesCB, GetId, 255)
