...
CONFIG(release, debug|release): {
    TARGET = DynamicAlgorithmPlugin
} else:CONFIG(debug, debug|release): {
    TARGET = DynamicAlgorithmPlugin_d
}

DEFINES += DYNAMICALGORITHMRPCPLUGIN_LIBRARY
